...
# Paths
excel_path = "C:\\Users\\kerem\\OneDrive\\Desktop\\Clean\\Prompts and Images.xlsx"
image_dir = "C:\\Users\\kerem\\OneDrive\\Desktop\\Clean\\Images"

# Read the Excel file from 'Sheet1', starting from Row 3, Columns B and C
df = pd.read_excel(excel_path, sheet_name='Sheet1', usecols="B:C", header=1, skiprows=1)
...
# 'prompt_image_mapping' now contains each prompt and its associated images
